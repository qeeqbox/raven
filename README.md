...
Raven - An Advanced Threat Attack Map (Simplified, customizable, responsive). And, can be used offline in an isolated environments without interacting with external lookups!
